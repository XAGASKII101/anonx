...
const removeimgCommand = require("./commands/removeimg")
const whoamiCommand = require("./commands/whoami")

// Global settings
global.packname = settings.packname
global.author = settings.author
global.channelLink = "https://whatsapp.com/channel/0029Vb6K4Nh4Crfdee0XJe35"
global.ytch = "ANONYMOUS X"
...
const channelInfo = {
  contextInfo: {
    ...
    forwardedNewsletterMessageInfo: {
      newsletterJid: "0029Vb6K4Nh4Crfdee0XJe35@newsletter",
      newsletterName: "𝓟𝓱𝓪𝓷𝓽𝓸𝓶 𝓧 MD",
      serverMessageId: -1,
    },
  },
}
    ...
    if (isGroup && isAdminCommand) {
      ...
      if (!isBotAdmin) {
        await sock.sendMessage(
          chatId,
          { text: "Please make the bot an admin to use admin commands.", ...channelInfo },
          { quoted: message },
        )
        return
      }
    ...
    switch (true) {
      ...
      case userMessage.startsWith(".guess"):
        ...
        if (guessedLetter) {
          ...
          await sock.sendMessage(chatId, { text: "Please guess a letter using .guess <letter>", ...channelInfo })
        }
        break
      ...
      case userMessage.startsWith(".answer"):
        ...
        if (answer) {
          ...
          await sock.sendMessage(chatId, { text: "Please provide an answer using .answer <answer>", ...channelInfo })
        }
        break
      ...
      case userMessage === ".jid":
        ...
        break
      case userMessage === ".removeimg" || userMessage === ".remimg":
        await removeimgCommand(sock, chatId, message)
        break
      case userMessage === ".whoami" || userMessage === ".whois":
...
async function handleGroupParticipantUpdate(sock, update) {
  try {
    ...
    if (action === "add") {
      ...
      const channelId = welcomeData?.channelId || "0029Vb6K4Nh4Crfdee0XJe35@newsletter"
    ...
    if (action === "remove") {
      ...
      const channelId = goodbyeData?.channelId || "0029Vb6K4Nh4Crfdee0XJe35@newsletter"
